...
// Keep the old trait temporarily to satisfy tests while we transition.
...
pub struct SpecifyPhaseRunner;
impl Default for SpecifyPhaseRunner {
    fn default() -> Self {
        Self
    }
}
impl SpecifyPhaseRunner {
    pub fn new() -> Self {
        Self
    }
}
impl PhaseRunner for SpecifyPhaseRunner {
    fn run_phase(
        &self,
        _: &str,
        _: &str,
