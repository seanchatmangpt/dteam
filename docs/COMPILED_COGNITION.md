...
`docs/COMPILED_COGNITION.md` is retained as a stable repository path, but it is no longer an authoritative document.

- Exact archived source: [docs/archive/source/docs/COMPILED_COGNITION.md.txt](archive/source/docs/COMPILED_COGNITION.md.txt)
