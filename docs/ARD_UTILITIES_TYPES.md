...
`docs/ARD_UTILITIES_TYPES.md` is retained as a stable repository path, but it is no longer an authoritative document.

- Exact archived source: [docs/archive/source/docs/ARD_UTILITIES_TYPES.md.txt](archive/source/docs/ARD_UTILITIES_TYPES.md.txt)
