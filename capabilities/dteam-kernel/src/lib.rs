...
pub mod prelude {
    pub use crate::{
        ...
        HookRegistry, InnovationAudit, InnovationDimension, Intent, IntentTemplate,
        MachineInstance, MigrationPlan, MigrationStep, Mutation, NodeId, ObjectEventLog, ObjectId,
        ObjectRecord, ObjectType, Observation, OperationId, Outcome, PayloadTemplate, PolicyId,
        Predicate, PreflightRefusal, PrincipalId, ProvenanceGraph, ProvenanceNode, QolCatalog,
        QuotaClaim, QuotaManager, QuotaPolicy, ReceiptQuery, RecordKey, Relation, RepairPlan,
        ReservationId, ReservationRequest, ResourceId, Route, Router, Rule, Runtime,
        ServiceObjective, StateId, StateMachine, SubjectId, SupportBundle, Task, TaskExecutor,
        TaskGraph, TaskId, TaskOutcome, TelcoTopology, Transaction, TransactionalStore, Transition,
