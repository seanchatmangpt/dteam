...
`apps/matrix-tv/README.md` is retained as a stable repository path, but it is no longer an authoritative document.

- Exact archived source: [docs/archive/source/apps/matrix-tv/README.md.txt](../../docs/archive/source/apps/matrix-tv/README.md.txt)
