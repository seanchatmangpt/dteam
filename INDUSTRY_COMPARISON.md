...
`INDUSTRY_COMPARISON.md` is retained as a stable repository path, but it is no longer an authoritative document.

- Exact archived source: [docs/archive/source/INDUSTRY_COMPARISON.md.txt](docs/archive/source/INDUSTRY_COMPARISON.md.txt)
