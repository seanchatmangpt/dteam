...
tex_path = os.path.join(docs_dir, "blue_river_dam_maximum.tex")
...
print(f"Written MAXIMUM DENSITY hyper-verbose HBR Executive Dissertation to {tex_path}")

subprocess.run(["pdflatex", "-interaction=nonstopmode", "blue_river_dam_maximum.tex"], cwd=docs_dir)
subprocess.run(["pdflatex", "-interaction=nonstopmode", "blue_river_dam_maximum.tex"], cwd=docs_dir)
print(f"Generated MAXIMUM DENSITY HBR thesis PDF at {docs_dir}/blue_river_dam_maximum.pdf")
