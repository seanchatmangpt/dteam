...
`WIP_REPORT_8H.md` is retained as a stable repository path, but it is no longer an authoritative document.

- Exact archived source: [docs/archive/source/WIP_REPORT_8H.md.txt](docs/archive/source/WIP_REPORT_8H.md.txt)
