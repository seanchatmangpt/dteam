...
`CCOG_INSA_ARCHITECTURE.md` is retained as a stable repository path, but it is no longer an authoritative document.

- Exact archived source: [docs/archive/source/CCOG_INSA_ARCHITECTURE.md.txt](docs/archive/source/CCOG_INSA_ARCHITECTURE.md.txt)
